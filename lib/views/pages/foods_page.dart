...
class _FoodsPageState extends State<FoodsPage> {
  ...
  Future<void> _scanExpiryDate(
    BuildContext context,
    Function(DateTime) onDateScanned,
  ) async {
    await Navigator.of(context).push(
      MaterialPageRoute(
        builder:
              ...
              onScanned: (barcode) {
                ...
                if (parsedDate != null) {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text(
                        "Couldn't parse date from barcode: $barcode",
                      ),
                                      ...
                                      (context) => Column(
                                        ...
                                        children: [
                                          ListTile(
                                            ...
                                            title: const Text(
                                              'Scan expiry date from barcode',
                                            ),
                                            onTap: () async {
                                              await _scanExpiryDate(context, (
                                                date,
                                              ) {
            ...
            SliverAppBar(
              ...
              flexibleSpace: FlexibleSpaceBar(
                ...
                background: Container(
                  ...
                  child: const Center(
                    child: Icon(Icons.kitchen, size: 60, color: Colors.white),
                  ),
                ),
              ),
              actions: [
